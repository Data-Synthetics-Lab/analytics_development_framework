...
SELECT c.id AS customerId, -- unique customer id
  ...
  sum(o.orderValue) OVER (Partition By o.customerId Order By o.created_date Unbounded Preceding) AS Value_to_date -- Running cumulative sum of all orders for that client through current order
